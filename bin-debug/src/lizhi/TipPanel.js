...
(function (lizhi) {
    var TipPanel = (function (_super) {
        ...
        TipPanel.prototype.createTipPanel = function () {
            ...
            this._3.x = (lizhi.getWidth() - this._3.width) / 2 + 10;
            this._3.y = (lizhi.getHeight() - this._3.height) / 2 - 120;
            this._2.x = (lizhi.getWidth() - this._3.width) / 2 + 10;
            this._2.y = (lizhi.getHeight() - this._3.height) / 2 - 120;
            this._1.x = (lizhi.getWidth() - this._3.width) / 2 + 10;
            this._1.y = (lizhi.getHeight() - this._3.height) / 2 - 120;
            this._go.x = (lizhi.getWidth() - this._3.width) / 2 + 10;
            this._go.y = (lizhi.getHeight() - this._3.height) / 2 - 120;
